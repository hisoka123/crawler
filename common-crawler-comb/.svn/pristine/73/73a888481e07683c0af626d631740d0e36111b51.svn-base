...
@Component
public class CreditCompanyFeedListParser extends AbstractParser{
	
	private static final Logger log = LoggerFactory.getLogger(CreditCompanyFeedListParser.class);
	
	public List<CreditJson> creditCompanyParser(String html) {
		...
		Element ele = eles.get(1);//eles.get(0) 个人信息 ；eles.get(1) 单位信息
