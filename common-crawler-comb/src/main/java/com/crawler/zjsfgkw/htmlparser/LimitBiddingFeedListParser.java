...
@Component
public class LimitBiddingFeedListParser extends AbstractParser{
	
	private static final Logger log = LoggerFactory.getLogger(LimitBiddingFeedListParser.class);
	...
	public List<CreditJson> creditParser(String html) {
		...
		Element ele_result=eles.get(6);//eles.get(6) 限制招投标
