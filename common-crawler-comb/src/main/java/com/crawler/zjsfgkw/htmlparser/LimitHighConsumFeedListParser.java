...
@Component
public class LimitHighConsumFeedListParser extends AbstractParser{
	
	private static final Logger log = LoggerFactory.getLogger(LimitHighConsumFeedListParser.class);
	...
	public List<CreditJson> creditParser(String html) {
		...
		Element ele = eles.get(0);//eles.get(0) 限制高消费 ；eles.get(1) 限制出境；eles.get(2) 限制招投标
