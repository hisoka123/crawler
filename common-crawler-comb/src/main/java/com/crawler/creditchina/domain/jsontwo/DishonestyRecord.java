...
public class DishonestyRecord implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4410091355130488363L;

	private String inforSource;// 信息来源（现网站暂无该字段）
	...
	public String toString() {
		return "DishonestyRecord [inforSource=" + inforSource
