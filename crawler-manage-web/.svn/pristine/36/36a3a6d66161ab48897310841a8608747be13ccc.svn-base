            ...
            <div data-name="chooseSearchType" class="row" style="margin-left:1%;padding:10px 0px">
              <span data-name="taskSearchType" style="font-weight:bold">搜索类型：</span>
                                    <span id="chose_searchType" style="font-size:13px">
                                          ...
                                          <span data-name="searchType_corpCode">13位经营者代码</span>
                                          <span data-name="searchType_corpName">经营者名称</span>
                                          <span data-name="searchType_scCode">统一社会信用代码</span>
                                    </span>
            </div>
...
<script src="${ctx}/static/js/ownerTask/iecms/iecms-common.js"></script>
