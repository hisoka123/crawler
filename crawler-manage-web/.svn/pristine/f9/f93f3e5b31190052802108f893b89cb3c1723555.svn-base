            ...
            <div data-name="chooseSearchType" class="row" style="margin-left:1%;padding:10px 0px">
              <span data-name="taskSearchType" style="font-weight:bold">搜索类型：</span>
                                    <span id="chose_searchType" style="font-size:13px">
                                          ...
                                          <span data-name="searchType_IDCard">身份证号</span>
                                    </span>
            </div>
...
<script src="${ctx}/static/js/ownerTask/creditUnion/creditUnion-ajax.js"></script>
<script src="${ctx}/static/js/ownerTask/creditUnion/creditUnion-common.js"></script>
