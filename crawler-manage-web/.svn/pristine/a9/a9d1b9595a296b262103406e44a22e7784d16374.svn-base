				...
				<div id="right_content" class="sr-zql-content-right sr-h-font" style="padding-left:20px;margin-right:0px">
				     ...
				     <div data-name="breadcrumb">
                          <div id="breadcrumbPath">
                              ...
                              <script type="text/javascript">
                                   $(function(){
                                       var path_1="<a href='${sipoIndexPath}'>专利网</a>";
                                       var path_2="<a href='${sipoSearchPath}'>搜索企业</a>";
                                       $("#path_1").html(path_1);
                                       $("#path_2").html(path_2);
                                   })
                               </script>
                    ...
                    <div data-name="searchBox" class="row" id="gxsearch">               
                     ...
                     <div id="type" class="row" style="margin-top:3%">
                       <div class="col-md-5 col-md-offset-2">
                              <label class="checkbox-inline">
                                     <input name="type" type="radio" value="fmgb" checked >发明公布
                                     <input name="type" type="radio"  value="fmsq" style="margin-left:10px"> 发明授权
                                     <input name="type" type="radio" value="xxsq" style="margin-left:10px"> 实用新型
                                     <input name="type" type="radio"  value="wgsq" style="margin-left:10px"> 外观设计
                              </label>
