...
public class ZjsfgkwLimitHighConsumController {

	private static final Logger log = LoggerFactory.getLogger(ZjsfgkwLimitHighConsumController.class);
	...
	/**
	   ...
	   */
	@RequestMapping(value = "/limitHighConsum")
	@ResponseBody
    public String execute(@RequestParam("txtReallyName") String txtReallyName,@RequestParam("txtCredentialsNumber") String txtCredentialsNumber,
		...
		String creditJson=null;
		 try {
			  ...
			  Result<List<CreditJson>> result = zjsfgkwLimitHighConsumService.searchLimitHighConsum(url,isDebug,logback);
