...
<script src="${ctx}/static/js/ownerTask/authenticate/authenticateOT-ajax.js"></script>
<script src="${ctx}/static/js/ownerTask/authenticate/authenticateOT-common.js"></script>
