...
<body>
				...
				<div id="right_content" class="sr-zql-content-right sr-h-font"
					...
					<div data-name="breadcrumb">
						<div id="breadcrumbPath">
							...
							<script type="text/javascript">
								$(function() {
									var path_1 = "<a href='${creditchinaIndexPath}'>信用中国</a>";
									var path_2 = "<a href='${creditchinaSearchPath}'>搜索企业</a>";
									$("#path_1").html(path_1);
									$("#path_2").html(path_2);
								})
							</script>
					...
					<div data-name="searchBox" class="row" id="gxsearch">
						<div id="searchBox_big" class="col-md-8 col-md-offset-2"
							style="margin-top: 12%">
							<jsp:include page="${searchBoxBigPath}"></jsp:include>
						</div>
					</div>
					<div id="chooseDataSource" class="row"
						style="margin-top: 3%; display: none">
						<div class="col-md-5 col-md-offset-3">
							<label class="checkbox-inline"> <input
								name="chooseDataSource" type="radio" value="interfaceVersion"
								checked> 接口版
							</label> <label class="checkbox-inline"> <input
								name="chooseDataSource" type="radio" value="dbVersion">
								数据库版
							</label>
						</div>
					</div>
					<div id="info" class="row" style="margin-top: 5%; display: none">
						<div class="col-md-7 col-md-offset-3" style="color: red"></div>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="${ctx}/static/js/creditchina/creditchina-common.js"></script>
	<script src="${ctx}/static/js/creditchina/creditchina-ajax.js"></script>
	<script
		src="${ctx}/static/js/ownerTask/creditchina/creditchina-ajax.js"></script>
</body>
</html>