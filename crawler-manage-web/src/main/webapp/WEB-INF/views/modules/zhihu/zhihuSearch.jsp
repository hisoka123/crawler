				...
				<div id="right_content" class="sr-zql-content-right" style="padding-left:20px;margin-right:0px">
				     ...
				     <div data-name="breadcrumb">
                          <div id="breadcrumbPath">
                              ...
                              <script type="text/javascript">
                                   $(function(){
                                       var path_1="<a href='${zhihuIndexPath}'>知乎</a>";
                                       var path_2="<a href='${zhihuSearchPath}'>搜索用户</a>";
                                       $("#path_1").html(path_1);
                                       $("#path_2").html(path_2);
                                   })
                               </script>
                    ...
                    <div data-name="searchResults" class="row" >
                         <div id="zhihu_searchResults" class="sr-h-font col-md-9" style="display:none"></div>
                         <div id="zhihu_searchResultsRightIcon" class="col-md-3" style="display:none">
                              <div>
                                        ...
                                        <div id="contrast_detail" class="panel panel-default" style="width:155px;float:right"> 
                                             <div class="panel-heading" style="text-align:center">
                                                 <strong>
                                                     ...
                                                     <span style="cursor:pointer" title="知乎对比详情">对比详情</span>
                                                 </strong>
                                              </div>
                                             <ul class="list-group">
                                             </ul>
                                             <div style="text-align:center;padding-top:5px;padding-bottom:5px">
                                                  <span class="sr-h-fontColor" style="cursor:pointer" onclick="lookAllContrastORLookDetail(this,'zhihu');"><strong title="对比多个人物详情">对&nbsp;&nbsp;比</strong></span>
                                                  &nbsp;&nbsp;&nbsp;
                                   ...
                                   <div class="col-md-3">
                                        <div id="smallSearchIcon" class="sr-h-rightIconDiv">
                                             <i id="smallSearchIcon" class="glyphicon glyphicon-search sr-h-rightSearchStyle"  onClick="rightSearchIcon('zhihu_searchResultsRightIcon');"></i>
                                        </div>
...
$(function(){
	 ...
	 ROOTPATH="${ctx}";
	 searchBoxPlaceholder("zhihu");
	 leftMenu();
	 connectIndexedDB();
	  
	  
	  $("#searchBox_big_btn").click(function(){
		     zhihu_action(searchBox_Big());
	  })
	  
	  $("#searchBox_small_btn").click(function(){
		     zhihu_action(searchBox_small()); 
	  })
});
</script>
