        ...
        <div data-name="chooseConditions" class="row">
          ...
          <div data-name="chooseConditions_2" class="col-md-5 col-md-offset-1" >
            ...
            <div class="input-group" style="padding-bottom:5px">
              <input id="searchKeyword" type="text" class="form-control" placeholder="请输入企业名称或组织机构代码或社会信用代码." maxlength="50">
...
<script src="${ctx}/static/js/ownerTask/customs/customsOT-ajax.js"></script>
<script src="${ctx}/static/js/ownerTask/customs/customsOT-common.js"></script>
<script src="${ctx}/static/js/customs/customs-ajax.js"></script>
