            ...
            <div data-name="chooseSearchType" class="row" style="margin-left:1%;padding:10px 0px">
              <span data-name="taskSearchType" style="font-weight:bold">搜索类型：</span>
                                    <span id="chose_searchType" style="font-size:13px">
                                          ...
                                          <span data-name="searchType_fmsq">发明授权</span>
                                          <span data-name="searchType_fmgb">发明公布</span>
                                          <span data-name="searchType_xxsq">实用新型</span>
                                          <span data-name="searchType_wgsq">外观设计</span>
                                    </span>
            </div>
...
<script src="${ctx}/static/js/ownerTask/sipo/sipoOT-ajax.js"></script>
<script src="${ctx}/static/js/ownerTask/sipo/sipoOT-common.js"></script>
