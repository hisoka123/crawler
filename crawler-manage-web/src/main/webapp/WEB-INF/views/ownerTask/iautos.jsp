        ...
        <div data-name="chooseConditions" class="row">
          ...
          <div data-name="chooseConditions_2" class="col-md-5 col-md-offset-1" >
            ...
            <div class="input-group" style="padding-bottom:5px">
              <input id="searchKeyword" type="text" class="form-control" placeholder="搜索你喜欢的车型，如宝马" maxlength="50">
...
<script src="${ctx}/static/js/ownerTask/iautos/iautos-ajax.js"></script>
<script src="${ctx}/static/js/ownerTask/iautos/iautos-common.js"></script>
<script src="${ctx}/static/js/iautos/iautos-ajax.js"></script>
