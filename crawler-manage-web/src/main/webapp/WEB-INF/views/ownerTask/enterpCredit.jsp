  ...
  <div id="body" class="row">
    ...
    <div class="col-md-10">
      <div id="right_content" class="sr-zql-content-right sr-h-font" style="padding-left:20px;margin-right:0px">
        <p class="tableName">11315企业征信任务列表</p>
        <div data-name="chooseConditions" class="row">
          ...
          <div data-name="chooseConditions_2" class="col-md-5 col-md-offset-1" >
            ...
            <div class="input-group" style="padding-bottom:5px">
              <input id="searchKeyword" type="text" class="form-control" placeholder="请输入关键字." maxlength="50">
...
<script src="${ctx}/static/js/ownerTask/enterpcredit/enterpCreditOT-ajax.js"></script>
<script src="${ctx}/static/js/ownerTask/enterpcredit/enterpCreditOT-common.js"></script>
