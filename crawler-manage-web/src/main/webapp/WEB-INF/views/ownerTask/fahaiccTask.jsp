            ...
            <div data-name="chooseSearchType" class="row" style="margin-left:1%;padding:10px 0px">
              <span data-name="taskSearchType" style="font-weight:bold">搜索类型：</span>
                                    <span id="chose_searchType" style="font-size:13px">
                                          ...
                                          <span data-name="searchType_name">个人/企业名称</span>
                                          <span data-name="searchType_IDCard">身份证号码/组织机构代码</span>
                                    </span>
            </div>
...
<script src="${ctx}/static/js/ownerTask/fahaiccTask/fahaiccTask-ajax.js"></script>
<script src="${ctx}/static/js/ownerTask/fahaiccTask/fahaiccTask-common.js"></script>
<script src="${ctx}/static/js/fahaicc/fahaicc-ajax.js"></script>
