                        ...
                        <div data-name="chooseSearchType" class="row" style="margin-left:1%;padding:10px 0px">
                            <span data-name="taskSearchType" style="font-weight:bold">搜索类型：</span>
                                    <span id="chose_searchType" style="font-size:13px">
                                          ...
                                          <span data-name="searchType_name">姓名</span>
                                          <span data-name="searchType_IDCard">证件号码</span>
                                          <span data-name="searchType_caseNum">案号</span>
                                          <span data-name="searchType_executionCourt">执行法院</span>
                                          <%--<span data-name="searchType_filingTime">立案日期</span>--%>
                                    </span>
                        </div>
...
<script src="${ctx}/static/js/ownerTask/zjcourtTask/zjcourtTask-ajax.js"></script>
<script src="${ctx}/static/js/ownerTask/zjcourtTask/zjcourtTask-common.js"></script>
