        ...
        <div data-name="chooseConditions" class="row">
          <div data-name="chooseConditions_1" class="col-md-6" >
            <div data-name="chooseSearchType" class="row" style="margin-left:1%;padding:10px 0px">
              <span data-name="taskSearchType" style="font-weight:bold">主体类型：</span>
                                    <span id="chose_searchType" style="font-size:13px">
                                          <span data-name="searchType_all">全部</span>
                                          <span data-name="searchType_name">自然人</span>
                                          <span data-name="searchType_legalPerson">法人</span>
                                    </span>
            </div>
          ...
          <div data-name="chooseConditions_2" class="col-md-5 col-md-offset-1" >
            ...
            <div class="input-group" style="padding-bottom:5px">
              <input id="searchKeyword" type="text" class="form-control" placeholder="请根据主体类型输入关键字。" maxlength="50" disabled>
...
<script src="${ctx}/static/js/ownerTask/creditchina/creditchina-ajax.js"></script>
<script src="${ctx}/static/js/ownerTask/creditchina/creditchina-common.js"></script>
