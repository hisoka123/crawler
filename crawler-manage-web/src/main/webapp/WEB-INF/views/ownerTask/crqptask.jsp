  ...
  <div id="body" class="row">
    ...
    <div class="col-md-10">
      <div id="right_content" class="sr-zql-content-right sr-h-font" style="padding-left:20px;margin-right:0px">
        <p class="tableName">失信记录查询平台任务列表</p>
...
<script src="${ctx}/static/js/ownerTask/crqp/crqpOT-ajax.js"></script>
<script src="${ctx}/static/js/ownerTask/crqp/crqpOT-common.js"></script>
