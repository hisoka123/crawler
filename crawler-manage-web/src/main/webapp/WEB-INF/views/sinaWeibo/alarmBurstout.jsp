...
<body>
	...
	<div class="sina-content">
		<h3 style="text-align: center">突发报警事件展示页面</h3>
		<input id="alarmIdHidden" type="hidden"
							value="${alarm.id}">
		<br>
	...
	<script>
		$(function() {
			...
			setInterval(function(){
				$.get("${ctx}/sinaWeibo/getCountTidByAlarm/"+alarmId, function(newCount){
			...
			$("nav ul.pagination li:first")
					.click(
							function() {
								location.href = "${ctx}/sinaWeibo/alarmBurstoutList?id="+alarmId+"&&pageNumber="
										+ page
										+ "&&pageSize="
										+ size
										+ "&&pageOption=first"
