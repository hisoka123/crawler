//从接口处获取详情
function dailianmengAjax_getDetailFromInterface(ctx,async,queryType,keyword,callFunName){
	    
	     var getDetailFromInterfaceResult='';
	     $.ajax({
	    	      url:ctx+"/api/dailianmeng/getDataOnce",
	    	      type:"post",
	    	      async:async,
	    	      data:{
	    	    	   queryType:queryType,
...
//以post方式向详情页传递参数
function dailianmengAjax_windowOpenPostDetail(url,name,content){
...
//以post方式传递调试内容
function dailianmengAjax_windowOpenPostInterface(url,data,dataContent,error,errorContent){
...
function dailianmengAjax_checkIsExist(ctx,async,queryType,content,callFunName){
	
	     var getDetailFromDBResult='';
	     
	     $.ajax({
	    	 
	    	     url:ctx+"/modules/dailianmeng/checkIsExist",
	    	     type:"post",
	    	     async:async,
	    	     data:{
	    	    	   queryType:queryType,
