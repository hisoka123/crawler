...
<html>
	...
	<body>
		<div class="wrap">
			<div class="banner-bg">
				<div class="banner"><img src="${ctx}/static/images/p-banner.jpg"></div>
			...
			<div class="content">
				...
				<ul class="fn-clear list pd-b10b">
					<li class="fl wd40b">
						
						<p class="txt-c fz24">产品1</p>
						<p class="fz14 lh30 gray1 mg-t8b">上容数据库SRDB凭着超稳定的运行，并且提供了数据安全无风险、功能强大易扩展、操作简单易维政务的发起、准备、派遣、处理、验证、总结等步骤，以此政务的发起、准备、派遣、处理、验证、总结等步骤，以此护数据处理工具，打造运营高效的金融生态圈。<a href="" class="orange1 mg-l15">[更多]</a></p>
					</li>
					<li class="fr wd40b">
						
						<p class="txt-c fz24">产品2</p>
						<p class="fz14 lh30 gray1 mg-t8b">上容数据库基于事件驱动的流程完成对办公政务的发起、准备、派遣、处理、验证、总结等步骤，政务的发起、准备、派遣、处理、验证、总结等步骤，以此政务的发起、准备、派遣、处理、验证、总结等步骤，以此政务的发起、准备、派遣、处理、验证、总结等步骤，以此以此组成O2O闭环处理，实现“精细化、责任化”<a href="" class="orange1 mg-l15">[更多]</a></p>
					</li>
			...
			<div class="footer" style="height:120px;">
				...
				<div class="fn-clear ft-list" style="padding-top:3.5%;">
