...
public class Sichuang {
	
	private static WebClient webClient = null;
	
	private static String url = "http://gsxt.scaic.gov.cn/ztxy.do?method=index&random=1465037498397";
	...
	public static void main(String[] args) throws FailingHttpStatusCodeException, MalformedURLException, IOException, InterruptedException {
		...
		HtmlImage image = htmlPage.getFirstByXPath("//img[@id='img']");  
		File imageFile = new File("D:\\eclipse\\sichuang111.jpg");
