...
public class ZjsfgkwLimitBiddingFunction {
	
	public String search(WebParam webParam) throws Exception {
		ChannelLogger LOGGER = ChannelLoggerFactory.getLogger(ZjsfgkwLimitBiddingFunction.class, webParam.getLogback());
		Map<String, String> resultMap = new LinkedHashMap<String, String>();
		Gson gson = new GsonBuilder().create();
		LOGGER.info("==================ZjsfgkwCreditPersonalFunction.search start!======================");
		...
		//点击提交请求
		HtmlElement personalButton = (HtmlElement)(searchPage.getElementsByIdAndOrName("btnComSearch").get(0)); 
...
/*		public static void main(String[] args) throws Exception {
			ZjsfgkwLimitBiddingFunction function=new ZjsfgkwLimitBiddingFunction();
	...
	String asXml=function.search(webParam);
