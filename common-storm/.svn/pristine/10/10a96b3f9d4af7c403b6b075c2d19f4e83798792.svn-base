...
public class WebParam{
	...
	private List<Map<String,Object>> paramsWithXpath; //[xpath-name-value]
	
	private String clickBtnXpath; //点击按钮的xpath
	...
	public List<Map<String, Object>> getParamsWithXpath() {
		return paramsWithXpath;
	}

	public void setParamsWithXpath(List<Map<String, Object>> paramsWithXpath) {
		this.paramsWithXpath = paramsWithXpath;
	}
	
	public String getClickBtnXpath() {
		return clickBtnXpath;
	}

	public void setClickBtnXpath(String clickBtnXpath) {
		this.clickBtnXpath = clickBtnXpath;
	}
	...
	public String toString() {
		return "WebParam [url=" + url + ", unit=" + unit + ", method=" + method
				+ ", params=" + params + ", paramsWithXpath=" + paramsWithXpath
				+ ", clickBtnXpath=" + clickBtnXpath + ", searchPage="
				+ searchPage + ", codeImageId=" + codeImageId
				+ ", requestHeaders=" + requestHeaders + ", cookies=" + cookies
				+ ", jsoupCookies=" + jsoupCookies + ", serializedFileName="
				+ serializedFileName + ", logback=" + logback + "]";
	}
